# TODO : Choice of activation function      -  giving an option to choose the activation function
# TODO : Correct the issue with parallel Crossover
import math
import random
import numpy as np
import pandas as pd
...
class gaAnn():
    ...
    def __init__(self, dimensions=(8, 5), initialPopSize=100, iterations=10, elicitation_rate=0.01,
                 mutation_rate=0.0001, m=10, fileName="iris"):
    ...
    def main(self):
        ...
        while (iterations < self.n_iterations):  # Maximum Iteration Count = 100
            ...
            # Step 4: Crossover
            children = self.Crossover(bestPop)  # TODO : Correct issue here on using parallel crossover \
            # was generating less children on using self.parallel_crossover(bestPop)
...
a = gaAnn(fileName="../ANN/iris", initialPopSize=1000, m=5)
...
# ran multiple test and found better fitness but since dataset tried was iris - small dataset,
# couldn't see much improvement in the time taken - for large datasets it would be very efficient theoretically
